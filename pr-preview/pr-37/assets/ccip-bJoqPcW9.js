import { B as p, g as m, s as w, d as k, i as b, l as L, a as O, c as R, b as E, e as x, H as y, f as M } from "./main-xAmzSKuG.js";
class S extends p {
...
async function D(d, { blockNumber: s, blockTag: e, data: o, to: n }) {
  const { args: c } = k({ data: o, abi: [T] }), [t, i, l, a, r] = c, { ccipRead: f } = d, h = f && typeof (f == null ? void 0 : f.request) == "function" ? f.request : C;
  try {
    if (!b(n, t)) throw new q({ sender: t, to: n });
    const u = i.includes(L) ? await O({ data: l, ccipRequest: h }) : await h({ data: l, sender: t, urls: i }), { data: g } = await R(d, { blockNumber: s, blockTag: e, data: E([a, x([{ type: "bytes" }, { type: "bytes" }], [u, r])]), to: n });
    return g;
  } catch (u) {
