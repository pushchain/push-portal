...
let nt = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = true, s !== k) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const { is: _t, defineProperty: ft, getOwnPropertyDescriptor: vt, getOwnPropertyNames: At, getOwnPropertySymbols: yt, getPrototypeOf: mt } = Object, m = globalThis, B = m.trustedTypes, gt = B ? B.emptyScript : "", V = m.reactiveElementPolyfillSupport, S = (r, t) => r, T = { toAttribute(r, t) {
  ...
  return e;
} }, z = (r, t) => !_t(r, t), W = { attribute: true, type: String, converter: T, reflect: false, hasChanged: z };
...
class y extends HTMLElement {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (i.size > 0) for (const [o, n] of i) n.wrapped !== true || this._$AL.has(o) || this[o] === void 0 || this.P(o, this[o], n);
    }
    let e = false;
    const s = this._$AL;
    try {
...
var q;
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[S("elementProperties")] = /* @__PURE__ */ new Map(), y[S("finalized")] = /* @__PURE__ */ new Map(), V == null ? void 0 : V({ ReactiveElement: y }), ((q = m.reactiveElementVersions) != null ? q : m.reactiveElementVersions = []).push("2.0.4");
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
function b(r, t, e = r, s) {
  ...
  return (l == null ? void 0 : l.constructor) !== a && ((o = l == null ? void 0 : l._$AO) == null || o.call(l, false), a === void 0 ? l = void 0 : (l = new a(r), l._$AT(r, e, s)), s !== void 0 ? ((n = e._$Co) != null ? n : e._$Co = [])[s] = l : e._$Cl = l), l !== void 0 && (t = b(r, l._$AS(r, t.values), l, s)), t;
}
class wt {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: s }, parts: i } = this._$AD, o = ((e = t == null ? void 0 : t.creationScope) != null ? e : A).importNode(s, true);
    v.currentNode = o;
...
let D = class dt {
  ...
  constructor(t, e, s, i) {
    var o;
    this.type = 2, this._$AH = d, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = i, this._$Cv = (o = i == null ? void 0 : i.isConnected) != null ? o : true;
  }
  get parentNode() {
...
var Y;
X == null ? void 0 : X(C, D), ((Y = H.litHtmlVersions) != null ? Y : H.litHtmlVersions = []).push("3.1.4");
const xt = (r, t, e) => {
  var s, i;
...
var tt;
x._$litElement$ = true, x.finalized = true, (tt = globalThis.litElementHydrateSupport) == null || tt.call(globalThis, { LitElement: x });
const et = globalThis.litElementPolyfillSupport;
et == null ? void 0 : et({ LitElement: x });
var st;
...
var Tt = Object.defineProperty, Ht = Object.defineProperties, Mt = Object.getOwnPropertyDescriptors, it = Object.getOwnPropertySymbols, Nt = Object.prototype.hasOwnProperty, Rt = Object.prototype.propertyIsEnumerable, rt = (r, t, e) => t in r ? Tt(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e, jt = (r, t) => {
...
* SPDX-License-Identifier: BSD-3-Clause
*/
const zt = { attribute: true, type: String, converter: T, reflect: false, hasChanged: z }, Dt = (r = zt, t, e) => {
...
function qt(r) {
  return (t, e) => typeof e == "object" ? Dt(r, t, e) : ((s, i, o) => {
    ...
    return i.constructor.createProperty(o, n ? kt(jt({}, s), { wrapped: true }) : s), n ? Object.getOwnPropertyDescriptor(i, o) : void 0;
  })(r, t, e);
}
export {
  qt as O,
