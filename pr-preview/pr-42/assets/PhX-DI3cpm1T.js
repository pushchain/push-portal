import { n as L, Y as g, t as r, p as d, O as s, s as c } from "./property-DG_zVZHr.js";
var u = Object.defineProperty, w = Object.getOwnPropertyDescriptor, o = (a, i, p, l) => {
  for (var e = l > 1 ? void 0 : l ? w(i, p) : i, h = a.length - 1, n; h >= 0; h--) (n = a[h]) && (e = (l ? n(i, p, e) : n(e)) || e);
...
t.styles = d`
  ...
  `;
o([s({ type: String, reflect: true })], t.prototype, "size", 2);
o([s({ type: String, reflect: true })], t.prototype, "weight", 2);
o([s({ type: String, reflect: true })], t.prototype, "color", 2);
o([s({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
t = o([c("ph-x")], t);
export {
  t as PhX
};
