import { n as g, Y as d, t as r, p as u, O as p, s as c } from "./property-DG_zVZHr.js";
var w = Object.defineProperty, y = Object.getOwnPropertyDescriptor, o = (a, l, s, i) => {
  for (var e = i > 1 ? void 0 : i ? y(l, s) : l, h = a.length - 1, n; h >= 0; h--) (n = a[h]) && (e = (i ? n(l, s, e) : n(e)) || e);
...
t.styles = u`
  ...
  `;
o([p({ type: String, reflect: true })], t.prototype, "size", 2);
o([p({ type: String, reflect: true })], t.prototype, "weight", 2);
o([p({ type: String, reflect: true })], t.prototype, "color", 2);
o([p({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
t = o([c("ph-arrow-up")], t);
export {
  t as PhArrowUp
};
