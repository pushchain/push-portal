...
var w = Object.defineProperty, y = Object.getOwnPropertyDescriptor, a = (o, l, h, s) => {
  for (var e = s > 1 ? void 0 : s ? y(l, h) : l, p = o.length - 1, g; p >= 0; p--) (g = o[p]) && (e = (s ? g(l, h, e) : g(e)) || e);
...
t.styles = c`
  ...
  `;
a([i({ type: String, reflect: true })], t.prototype, "size", 2);
a([i({ type: String, reflect: true })], t.prototype, "weight", 2);
a([i({ type: String, reflect: true })], t.prototype, "color", 2);
a([i({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
