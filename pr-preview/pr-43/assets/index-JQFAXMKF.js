...
import { c as ae, u as le, i as J, r as b, d as v, e as h, h as se, w as d, v as u, E as ce, j as L, k as B, __tla as __tla_0 } from "./core-B1WOT50t.js";
import { cQ as c, __tla as __tla_1 } from "./main-0IMDdYLD.js";
let I, Tt, Qe, w, Ke, Je, l, S, _t, Xe;
let __tla = Promise.all([
  ...
  I = {
    ...
    generateAvatarColors(e) {
      const o = e.toLowerCase().replace(/^0x/iu, "").replace(/[^a-f0-9]/gu, "").substring(0, 6).padEnd(6, "0"), r = this.hexToRgb(o), n = getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"), a = 100 - 3 * Number(n == null ? void 0 : n.replace("px", "")), s = `${a}% ${a}% at 65% 40%`, p = [];
      for (let _ = 0; _ < 5; _ += 1) {
        const E = this.tintColor(r, 0.15 * _);
   ...
   `;
    ...
    getColorTheme(e) {
      var _a;
      return e || (typeof window < "u" && window.matchMedia && typeof window.matchMedia == "function" ? ((_a = window.matchMedia("(prefers-color-scheme: dark)")) == null ? void 0 : _a.matches) ? "dark" : "light" : "dark");
    },
    splitBalance(e) {
      const t = e.split(".");
      return t.length === 2 ? [
    ...
    maskInput({ value: e, decimals: t, integers: o }) {
      ...
      const [r = "", n] = e.split(G).map((E) => E.replace(/[^0-9]/gu, "")), i = o ? r.substring(0, o) : r, a = i.length === 2 ? String(Number(i)) : i, s = typeof t == "number" ? n == null ? void 0 : n.substring(0, t) : n, p = typeof t != "number" || t > 0;
  ...
  const ue = {
    ...
    if (i === void 0 && globalThis.litPropertyMetadata.set(n, i = /* @__PURE__ */ new Map()), r === "setter" && ((e = Object.create(e)).wrapped = true), i.set(o.name, e), r === "accessor") {
      const { name: a } = o;
      return {
        set(s) {
          const p = t.get.call(this);
          t.set.call(this, s), this.requestUpdate(a, p, e, true, s);
        },
        init(s) {
    ...
    if (r === "setter") {
      ...
      return function(s) {
        const p = this[a];
        t.call(this, s), this.requestUpdate(a, p, e, true, s);
      };
    }
...
`;
  ...
  const re = Symbol.for(""), fe = (e) => {
    if ((e == null ? void 0 : e.r) === re) return e == null ? void 0 : e._$litStatic$;
  }, me = (e) => ({
    _$litStatic$: e,
    r: re
  }), te = /* @__PURE__ */ new Map(), ve = (e) => (t, ...o) => {
    const r = o.length;
    let n, i;
    const a = [], s = [];
    let p, _ = 0, E = false;
    for (; _ < r; ) {
      for (p = t[_]; _ < r && (i = o[_], (n = fe(i)) !== void 0); ) p += n + t[++_], E = true;
...
`;
  ...
  const Ne = {
    ...
    "ph-wallet": () => c(() => import("./PhWallet-CW8w-FVc.js"), __vite__mapDeps([49,1])),
    "ph-warning": () => c(() => import("./PhWarning-S0Lsie3G.js"), __vite__mapDeps([50,1])),
    "ph-warning-circle": () => c(() => import("./PhWarningCircle-CQaWVwtU.js"), __vite__mapDeps([51,1])),
    "ph-x": () => c(() => import("./PhX-DI3cpm1T.js"), __vite__mapDeps([52,1]))
  }, qe = {
    appStore: we,
    apple: be,
    bitcoin: $e,
  ...
  let et;
  Ke = Qe(class extends Je {
    constructor(e) {
      var _a;
      if (super(e), e.type !== Xe.ATTRIBUTE || e.name !== "class" || ((_a = e.strings) == null ? void 0 : _a.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
    }
    render(e) {
    ...
    update(e, [t]) {
      ...
      if (this.st === void 0) {
        ...
        for (const r in t) t[r] && !((_a = this.nt) == null ? void 0 : _a.has(r)) && this.st.add(r);
      ...
      for (const r in t) {
        const n = !!t[r];
        n === this.st.has(r) || ((_b = this.nt) == null ? void 0 : _b.has(r)) || (n ? (o.add(r), this.st.add(r)) : (o.remove(r), this.st.delete(r)));
      }
      return ce;
    }
  });
...
`;
  ...
  let f = class extends v {
    constructor() {
      super(...arguments), this.walletImages = [], this.imageSrc = "", this.name = "", this.size = "md", this.tabIdx = void 0, this.namespaces = [], this.disabled = false, this.showAllWallets = false, this.loading = false, this.loadingSpinnerColor = "accent-100";
    }
    render() {
    ...
    templateNamespaces() {
      var _a;
      return ((_a = this.namespaces) == null ? void 0 : _a.length) ? h`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((t, o) => {
        var _a2;
        return h`<wui-flex
              alignItems="center"
              justifyContent="center"
              zIndex=${(((_a2 = this.namespaces) == null ? void 0 : _a2.length) ?? 0) * 2 - o}
...
`;
  ...
  let m = class extends v {
    constructor() {
      super(...arguments), this.type = "primary", this.imageSrc = "google", this.imageSize = void 0, this.loading = false, this.boxColor = "foregroundPrimary", this.disabled = false, this.rightIcon = true, this.boxed = true, this.rounded = false, this.fullSize = false;
    }
    render() {
