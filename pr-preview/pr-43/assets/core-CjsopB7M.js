  ...
  async function ou() {
    if (!ec) {
      const { createPublicClient: t, http: e, defineChain: n } = await ta(async () => {
        const { createPublicClient: s, http: r, defineChain: i } = await import("./index-D9OiwAGC.js");
        return {
...
`;
    ...
    async initialize(e) {
      ...
      if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), ((_a2 = e.features) == null ? void 0 : _a2.headless) && !At.hasInjectedConnectors() && se.prefetch({
        ...
        const { ReownAuthentication: n } = await ta(async () => {
          const { ReownAuthentication: r } = await import("./features-4_ayiZqe.js");
          return {
  ...
  class Nw extends rk {
    ...
    async injectModalUi() {
      if (!Gf && ee.isClient()) {
        if (await ta(() => import("./basic-Cg5D2C10.js"), __vite__mapDeps([5,6,1,2])), await ta(() => import("./w3m-modal-DgvKxPnE.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
