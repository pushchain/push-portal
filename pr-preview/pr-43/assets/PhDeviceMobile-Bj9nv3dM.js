import { n as l, Y as n, t as r, p as Z, O as s, s as A } from "./property-DG_zVZHr.js";
var v = Object.defineProperty, g = Object.getOwnPropertyDescriptor, h = (a, o, H, i) => {
  for (var e = i > 1 ? void 0 : i ? g(o, H) : o, p = a.length - 1, V; p >= 0; p--) (V = a[p]) && (e = (i ? V(o, H, e) : V(e)) || e);
...
t.styles = Z`
  ...
  `;
h([s({ type: String, reflect: true })], t.prototype, "size", 2);
h([s({ type: String, reflect: true })], t.prototype, "weight", 2);
h([s({ type: String, reflect: true })], t.prototype, "color", 2);
h([s({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
