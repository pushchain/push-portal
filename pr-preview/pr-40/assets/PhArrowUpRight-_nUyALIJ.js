...
var w = Object.defineProperty, L = Object.getOwnPropertyDescriptor, a = (o, s, h, i) => {
  for (var e = i > 1 ? void 0 : i ? L(s, h) : s, l = o.length - 1, n; l >= 0; l--) (n = o[l]) && (e = (i ? n(s, h, e) : n(e)) || e);
...
t.styles = u`
  ...
  `;
a([p({ type: String, reflect: true })], t.prototype, "size", 2);
a([p({ type: String, reflect: true })], t.prototype, "weight", 2);
a([p({ type: String, reflect: true })], t.prototype, "color", 2);
a([p({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
