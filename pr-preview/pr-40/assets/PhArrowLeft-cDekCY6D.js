import { n as g, Y as d, t as r, p as c, O as s, s as u } from "./property-DG_zVZHr.js";
var w = Object.defineProperty, f = Object.getOwnPropertyDescriptor, l = (a, o, h, i) => {
  for (var e = i > 1 ? void 0 : i ? f(o, h) : o, p = a.length - 1, n; p >= 0; p--) (n = a[p]) && (e = (i ? n(o, h, e) : n(e)) || e);
...
t.styles = c`
  ...
  `;
l([s({ type: String, reflect: true })], t.prototype, "size", 2);
l([s({ type: String, reflect: true })], t.prototype, "weight", 2);
l([s({ type: String, reflect: true })], t.prototype, "color", 2);
l([s({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
