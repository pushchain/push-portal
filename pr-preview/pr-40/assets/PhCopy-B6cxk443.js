import { n as l, Y as n, t as a, p as g, O as h, s as c } from "./property-DG_zVZHr.js";
var d = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, H = (r, V, i, o) => {
  for (var e = o > 1 ? void 0 : o ? Z(V, i) : V, s = r.length - 1, p; s >= 0; s--) (p = r[s]) && (e = (o ? p(V, i, e) : p(e)) || e);
...
t.styles = g`
  ...
  `;
H([h({ type: String, reflect: true })], t.prototype, "size", 2);
H([h({ type: String, reflect: true })], t.prototype, "weight", 2);
H([h({ type: String, reflect: true })], t.prototype, "color", 2);
H([h({ type: Boolean, reflect: true })], t.prototype, "mirrored", 2);
t = H([c("ph-copy")], t);
export {
  t as PhCopy
};
