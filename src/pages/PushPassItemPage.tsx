...
import { PushPassItem } from "../components/PushPass/PushPassItem";


const PushPassItemPage: React.FC = () => {
  return (
    <>
      <Helmet>
...
export default PushPassItemPage;

const PushPassItemWrapper = styled.div`
  width: 100%;
  display: flex;
